...
using Windows PowerShell or [PowerShell Core][pwsh] (on Windows).
...
The only prerequisites for building, testing, and deploying from this repository
are the [.NET SDK](https://get.dot.net/) and
Visual Studio with the components identified by .vsconfig installed.
